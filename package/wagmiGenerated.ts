// Generated by @wagmi/cli@1.1.0 on 6/5/2023 at 12:24:23 PM
...
export const zoraCreatorSignatureMinterStrategyABI = [
  { stateMutability: "nonpayable", type: "constructor", inputs: [] },
  ...
  { type: "error", inputs: [], name: "MissingFundsRecipient" },
  { type: "error", inputs: [], name: "SaleEnded" },
  { type: "error", inputs: [], name: "SaleHasNotStarted" },
  {
    type: "error",
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "valueSent", internalType: "uint256", type: "uint256" },
    ],
    name: "WrongValueSent",
  },
  {
    ...
    inputs: [
      ...
      {
        name: "signatureSaleSettings",
        internalType: "struct ZoraCreatorSignatureMinterStrategy.SalesConfig",
        type: "tuple",
        components: [
          {
            name: "authorizedSignatureCreators",
            internalType: "contract IReadableAuthRegistry",
            type: "address",
          },
        ],
        indexed: false,
  ...
  },
  {
    ...
    inputs: [
      {
        name: "mintRequestCalldata",
        internalType:
          "struct ZoraCreatorSignatureMinterStrategy.MintRequestCallData",
        type: "tuple",
        components: [
          { name: "nonce", internalType: "bytes32", type: "bytes32" },
          { name: "pricePerToken", internalType: "uint256", type: "uint256" },
